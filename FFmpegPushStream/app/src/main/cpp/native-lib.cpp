...
Java_com_zdd_ffmpegpushstream_MainActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
...
Java_com_zdd_ffmpegpushstream_MainActivity_stream(JNIEnv *env, jobject instance, jstring input_jstr,
                                                  jstring output_jstr) {
