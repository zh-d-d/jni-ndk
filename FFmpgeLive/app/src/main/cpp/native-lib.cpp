...
Java_com_zdd_ffmpgelive_LiveActivity_streamerInit(JNIEnv *env, jobject instance, jint width,
                                                  jint height) {

    int ret = 0;
    const char *address = "rtmp://192.168.5.110/oflaDemo/test";
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_zdd_ffmpgelive_LiveActivity_streamerHandle(JNIEnv *env, jobject instance,
                                                    jbyteArray data_) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_zdd_ffmpgelive_LiveActivity_streamerFlush(JNIEnv *env, jobject instance) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_zdd_ffmpgelive_LiveActivity_streamerRelease(JNIEnv *env, jobject instance) {
...
Java_com_zdd_ffmpgelive_MainActivity_liveFromFFmpeg(JNIEnv *env, jobject instance) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_zdd_ffmpgelive_MainActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
